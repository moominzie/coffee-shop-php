...
$sql="update member set FullName=:fname,MobileNumber=:mobileno where UserId=:uid";
...
<?php 
$uid=$_SESSION['uid'];
$sql="SELECT UserId,Username,FullName,EmailId,MobileNumber,RegDate,UpdationDate,Status from  member  where UserId=:uid ";
$query = $dbh -> prepare($sql);
$query-> bindParam(':uid', $uid, PDO::PARAM_STR);
$query->execute();
