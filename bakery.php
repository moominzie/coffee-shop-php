...
<h3 class="header-line" style="margin-top:30px; font-family: 'Fjalla One', sans-serif;text-transform:none;">Bakery</h3>
<?php 
...
<div class="image-box">
<a href="product-bakery.php?mid=<?php echo htmlentities($result->mid);?>" style="color: black" >
  <img src="admin/uploads/img/<?php echo htmlentities($result->Image1);?>" width="250" height="250" style=""></a>
  </div>
  <a href="product-bakery.php?mid=<?php echo htmlentities($result->mid);?>" style="color: black" ><h4 style="text-align:center;font-family: 'Fjalla One', sans-serif;"><?php echo htmlentities($result->MenuName);?></h4></a>
