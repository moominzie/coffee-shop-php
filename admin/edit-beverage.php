...
header('location:manage-beverage.php');
}
...
<div class="content-wrapper">
   <div class="container">
    <div class="row pad-botm">
            <div class="col-md-12">
            <h4 class="header-line" style="text-align:none; font-family: 'Noto Sans JP', sans-serif; font-size: 22px;"><?php echo htmlentities($result->MenuName);?> &nbsp<i class="fas fa-mug-hot"></i></h4>
                            </div>
        </div>
<div class="card-data">
...
<?php echo htmlentities($result->SizeName);?>&nbsp<?php echo htmlentities($result->Ounce);?> oz.
</div>
</div>
...
<?php echo htmlentities($result->TypeName);?>
</div>
</div>
...
<div class="col-md-12">                             
<button type="submit" name="update" class="create-account" style="margin-bottom:20px"> Update beverage </button>
</div>
                                    </form>
                            </div>
                        </div>
