...
$sql="update subcategory set SubCategory=:subcategory  where id=:subid";
...
$subid=intval($_GET['subid']);
$sql = "SELECT subcategory.SubCategory,subcategory.id as subid from subcategory where subcategory.id=:subid";
...
<div class="content-wrapper">
   <div class="container">
    <div class="row pad-botm">
            <div class="col-md-12">
            <h4 class="header-line" style="text-align:none; font-family: 'Noto Sans JP', sans-serif; font-size: 22px;"><?php echo htmlentities($result->SubCategory);?></h4>
                            </div>
        </div>
<div class="card">
...
<div class="col-md-12">                             
<button type="submit" name="update" class="create-account" style="margin-bottom:20px"> Update sub category </button>
</div>
                                    </form>
                            </div>
                        </div>
