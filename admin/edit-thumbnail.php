...
<div class="col-md-12">
<div class="form-group">
<img src="uploads/thumbnails/<?php echo htmlentities($result->Images);?>" width="570" height="570" style="border-radius:10px;">
</div>
</div>
<?php }} ?>
...
<div class="col-md-8">
    <div class="form-group">
        <label>Upload new Large thumbnail</label>&nbsp;<label for="" style="color: red;">* </label>&nbsp;<label for="" style="color: red"> Please use picture scale 570x570 px. </label>
...
<div class="col-md-12">                             
<button type="submit" name="update" class="create-account" > Update thumbnails </button> | <a href="edit-small1-thumbnail.php" style="color: #006400" > Edit Small1</a> | <a href="edit-small2-thumbnail.php" style="color: #006400" > Edit Small2 </a> | <a href="edit-small3-thumbnail.php" style="color: #006400" > Edit Small3</a> | <a href="edit-small4-thumbnail.php" style="color: #006400" > Edit Small4</a>
</div>
