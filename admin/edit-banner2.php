...
<div class="col-md-12">                             
<button type="submit" name="update" class="create-account" > Update banner </button> | <a href="edit-banner.php" style="color: #006400" > Edit Promotion Banner 1</a> | <a href="edit-banner3.php" style="color: #006400" >Edit Promotion Banner 3</a>
</div>
