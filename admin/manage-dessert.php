...
<div class="container">
    <div class="row pad-botm">
            <div class="col-md-12">
            <h4 class="header-line" style="text-align:none; font-family: 'Noto Sans JP', sans-serif; font-size: 22px;">Manage dessert and ice cream &nbsp<i class="fas fa-bread-slice"></i></h4>
                </div>
                <?php if($_SESSION['msg']!="")
{?>
                    ...
                    <div class="card-table">
                        <div class="panel-body" style="">
                            ...
                            <table class="table">
                                    ...
                                    <tbody>
<?php 
$sql = "SELECT menu.MenuName,menu.Description,menu.Price,menu.Image1,category.Category,subcategory.SubCategory,menu.id as mid,ProductCode from menu join category on menu.CategoryId=category.id join subcategory on menu.SubCategoryId=subcategory.id where menu.CategoryId in (4) group by menu.id";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                             ...
                                             <td class="center"><a href="edit-dessert.php?mid=<?php echo htmlentities($result->mid);?>" class="btn btn-success" style="border-radius:15px;background-color: #00A862;"><i class="fa fa-edit"></i> Edit</a>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
                                </table>
