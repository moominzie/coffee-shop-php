...
<div class="col-md-12">                             
<button type="submit" name="update" class="create-account" > Update banner </button> | <a href="edit-banner.php" style="color: #006400" > Edit Promotion Banner 1</a> | <a href="edit-food-banner.php" style="color: #006400" >Edit Promotion Banner 2</a>
</div>
