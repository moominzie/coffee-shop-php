...
if(isset($_POST['update']))
{
    ...
    $sql="update breadbanner set Images=:images";
...
$sql = "SELECT Images from breadbanner";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
<div class="col-md-12">                   
<button type="submit" name="update" class="btn btn-danger" style="font-family: 'Montserrat', sans-serif; letter-spacing: 1px;"> Upload </button> | <a href="edit-banner.php" style="font-family: 'Staatliches', cursive; letter-spacing: 1px; font-size:14px; color: #BB8FCE" > Edit Promotion Banner 1</a> | <a href="edit-food-banner.php" style="font-family: 'Staatliches', cursive; letter-spacing: 1px; font-size:14px; color: #BB8FCE" >Edit Promotion Banner 2</a>
</div>
                                    </form>
                            </div>
                        </div>
