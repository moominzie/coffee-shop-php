...
<div class="container">
    <div class="row pad-botm">
            <div class="col-md-12">
            <h4 class="header-line" style="text-align:none; font-family: 'Noto Sans JP', sans-serif; font-size: 22px;">Manage cake &nbsp<i class="fas fa-bread-slice"></i></h4>
                </div>
                <?php if($_SESSION['msg']!="")
{?>
...
{               ?>                                      
                                        ...
                                        <td class="center" style="display:none;"><?php echo htmlentities($cnt);?></td>
                                             ...
                                             <td class="center"><a href="edit-cake.php?mid=<?php echo htmlentities($result->mid);?>" class="btn btn-success" style="border-radius:15px;background-color: #00A862;"><i class="fa fa-edit"></i> Edit</a>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
                                </table>
